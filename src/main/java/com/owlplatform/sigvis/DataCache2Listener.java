...
public interface DataCache2Listener {
	public void receiverAdded(final String receiverId);
	
	public void transmitterAdded(final String transmitterId, final boolean isFiduciary);
